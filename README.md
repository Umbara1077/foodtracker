...
Engineering through **Phase 37 (target editor)** is implemented on stacked `cursor/project-plate-phase-*-fc9b` branches (merge order in [`docs/TESTFLIGHT.md`](docs/TESTFLIGHT.md)). Submit using [`docs/APP_STORE_SUBMISSION.md`](docs/APP_STORE_SUBMISSION.md).
...
| Power / retention | 35–37 | Custom gateway, reminders, CSV, analytics funnel, target editor |
