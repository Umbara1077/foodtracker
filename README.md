...
Engineering through **Phase 44 (History meal search)** is implemented on stacked `cursor/project-plate-phase-*-fc9b` branches (merge order in [`docs/TESTFLIGHT.md`](docs/TESTFLIGHT.md)). Submit using [`docs/APP_STORE_SUBMISSION.md`](docs/APP_STORE_SUBMISSION.md).
...
| Power / retention | 35–44 | Gateway, reminders, analytics, editors, copy/share, date picker, undo, Scan CTA, History search |
